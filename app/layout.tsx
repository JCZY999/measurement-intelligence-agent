...
export const metadata:Metadata={title:"Signal — Marketing Measurement Agent",description:"An AI agent that audits measurement, connects marketing to revenue, and recommends what to do next."};
